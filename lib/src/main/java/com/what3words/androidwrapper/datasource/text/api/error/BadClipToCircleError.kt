...
/**
 * Represents an error that occurs when an invalid circle is passed for the [com.what3words.core.types.options.W3WAutosuggestOptions.clipToCircle] property
 * in the [com.what3words.core.types.options.W3WAutosuggestOptions] to make a what3words request.
 *
 * This error typically indicates that the specified circle is not valid or does not conform to the required
...
class BadClipToCircleError(val code: String, override val message: String) : W3WApiError(
    ...
    override fun toString(): String {
        return "BadClipToCircleError(code='$code', message='$message')"
    }
}